<div id="site_comments">
    <?php if(Auth::check()): ?>
        ...
        <div class="comment-respond wow fadeInUp" id="respond" style="visibility: hidden; animation-name: none;">
                <h2><?php echo e(trans('sites.write_comment')); ?></h2>
                    ...
                    <form method="POST">
                        ...
                        <div class="f-row">
                            <div class="third bwrap">
                                <input type="submit" value="<?php echo e(trans('sites.submit_comment')); ?>" @click.prevent="submitComment">
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="comments wow fadeInUp animated" id="comments" style="visibility: visible; animation-name: fadeInUp;">
        <h2><?php echo e(trans('sites.comments')); ?></h2>
        <ol class="comment-list" v-for="comment in comments" v-if="comment.parent_id == null">
                ...
                <div class="comment-box">
                    <div class="comment-author meta">
                        <strong>{{ comment.user.name }}</strong>{{ comment.user.created_at }} &nbsp;&nbsp;
                            <?php if(Auth::check()): ?>
                                <a href="#" class="comment-reply-link reply" @click.prevent="clickReply(comment.id)"><?php echo e(trans('sites.reply')); ?></a>
                            <?php endif; ?>
            ...
            <div class="container two-third reply-content" :id="comment.id" hidden>
                <form method="POST">
                    ...
                    <input name="submit" type="submit" class="submit" value="<?php echo e(trans('sites.reply')); ?>" @click.prevent="submitReply(comment.id)">
                    <input name="reset" type="reset" class="cancel" value="<?php echo e(trans('sites.cancel')); ?>"@click.prevent="closeReply(comment.id)">
                </form>
            </div>
            ...
            <div class="container two-third reply-content" hidden :editId="comment.id">
                <form method="POST">
                    ...
                    <input name="submit" type="submit" class="submit" value="<?php echo e(trans('sites.update')); ?>" @click.prevent="updateComment(comment.id, comment.parent_id)">
                    <input name="reset" type="reset" class="cancel" value="<?php echo e(trans('sites.cancel')); ?>"@click.prevent="closeReply(comment.id, comment.parent_id)">
                </form>
            </div>
            ...
            <ol class="comment-list" v-for="reply in comment.sub">
                ...
                <div class="container two-third reply-content" hidden :editId="reply.id">
                    <form method="POST">
                        ...
                        <input name="submit" type="submit" class="submit" value="<?php echo e(trans('sites.update')); ?>" @click.prevent="updateComment(reply.id, reply.parent_id)">
                        <input name="reset" type="reset" class="cancel" value="<?php echo e(trans('sites.cancel')); ?>"@click.prevent="closeReply(reply.id, reply.parent_id)">
                    </form>
                </div>
            </ol>
           <!--//comment-->
