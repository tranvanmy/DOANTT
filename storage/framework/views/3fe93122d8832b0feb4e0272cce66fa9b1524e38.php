<?php $__env->startSection('style'); ?>
	<?php echo e(Html::style('sites_custom/css/add.css')); ?>
				...
				<div class="site-block" >
					<form id="checkout-wizard" method="post">
						...
						<div class="form-group text-right" id="control">
							<button class="btn-success" v-on:click.prevent="comfirmSubmit"><?php echo e(trans('sites.create_cooking')); ?></button>
							<button class="btn-warning" v-on:click.prevent="comfirmCancel"><?php echo e(trans('sites.cancel')); ?></button>
						</div>
						<div id="checkout-first" class="step">
							<!-- Step Info -->
							<ul class="nav nav-pills nav-justified checkout-steps push-bit">
								<li class="active"><a href="javascript:void(0)" data-gotostep="checkout-first" v-on:click.prevent="step1"><strong>1. <?php echo e(trans('sites.cooking_infomation')); ?></strong></a></li>
								<li><a href="javascript:void(0)" data-gotostep="checkout-second" v-on:click.prevent="step2"><strong>2. <?php echo e(trans('sites.cooking_ingredient')); ?></strong></a></li>
								<li><a href="javascript:void(0)" data-gotostep="checkout-third" v-on:click.prevent="step3"><strong>3. <?php echo e(trans('sites.cooking_step')); ?></strong></a></li>
								<li><a href="javascript:void(0)" data-gotostep="checkout-fourth" v-on:click.prevent="step4"><strong>4. <?php echo e(trans('sites.cooking_category')); ?></strong></a></li>
							</ul>
							<!-- END Step Info -->
							<div class="row">
								<div class="col-sm-6">
									<h4 class="page-header"><?php echo e(trans('sites.base_info')); ?></h4>
									<div class="form-group">
										<label for="checkout-username"><?php echo e(trans('sites.name_cooking')); ?></label>
									...
									<div class="form-group">
										<label for="time"><?php echo e(trans('sites.time')); ?></label>
									...
									<div class="form-group">
										<label for="ration"><?php echo e(trans('sites.ration')); ?></label>
									...
									<div class="form-group">
										<label for="level"><?php echo e(trans('sites.level_cooking')); ?></label>
										<select class="col-md-12" name="" id="" v-model="cooking.level_id">
											<option value="6"><?php echo e(trans('sites.easy')); ?></option>
											<option value="7"><?php echo e(trans('sites.normal')); ?></option>
											<option value="8"><?php echo e(trans('sites.hard')); ?></option>
										</select>
									...
									<br>
									<div class="form-group">
										<label for="description"><?php echo e(trans('sites.description')); ?></label>
						...
						<div id="checkout-second" class="step">
							<!-- Step Info -->
							<ul class="nav nav-pills nav-justified checkout-steps push-bit">
								<li><a href="javascript:void(0)" data-gotostep="checkout-first" v-on:click.prevent="step1"><strong>1. <?php echo e(trans('sites.cooking_infomation')); ?></strong></a></li>
								<li class="active"><a href="javascript:void(0)" data-gotostep="checkout-second" v-on:click.prevent="step2"><strong>2. <?php echo e(trans('sites.cooking_ingredient')); ?></strong></a></li>
								<li><a href="javascript:void(0)" data-gotostep="checkout-third" v-on:click.prevent="step3"><strong>3. <?php echo e(trans('sites.cooking_step')); ?></strong></a></li>
								<li><a href="javascript:void(0)" data-gotostep="checkout-fourth" v-on:click.prevent="step4"><strong>4. <?php echo e(trans('sites.cooking_category')); ?></strong></a></li>
							</ul>
							<!-- END Step Info -->
							<div class="row">
								<div class="col-sm-4">
									 <h4 class="page-header"><i class="fa fa-credit-card"></i> <?php echo e(trans('sites.input_ingredient')); ?></h4>
									<div class="form-group">
										<span for=""><?php echo e(trans('sites.ingredient_name')); ?></span>
										...
										<span for=""><?php echo e(trans('sites.quantity')); ?></span>
										...
										<span for=""><?php echo e(trans('sites.unit')); ?></span><br>
										...
										<span class="clearfix" for=""><?php echo e(trans('sites.note')); ?></span>

										<input type="text" v-model="cookingIngredient.description">
										<button class="btn-warning" v-if="ingredientIndex != null" v-on:click.prevent="sendIngredient"><?php echo e(trans('sites.edit_ingredient')); ?></button>
										<button class="btn-primary" v-if="ingredientIndex != null" v-on:click.prevent="cancelIngresient"><?php echo e(trans('sites.cancel')); ?></button>
										<i class="fa fa-plus-square-o fa-2x" aria-hidden="true" v-on:click.prevent="sendIngredient" v-else="ingredientIndex != null"></i>
									</div>
								</div>
								<div class="col-sm-8">
									<h4 class="page-header"><i class="fa fa-credit-card"></i><?php echo e(trans('sites.ingredient_list')); ?></h4>
									<div class="form-group">
									   <ol>
										   <li class="col-sm-6" v-for="(ingredient, index) in cooking.cooking_ingredients">
												<button class="btn-warning" v-if="ingredient.id == cookingIngredient.id" v-on:click.prevent="cancelIngresient"><?php echo e(trans('sites.editing')); ?></button>
												<span v-else="ingredient.id == cookingIngredient.id">
													<button class="btn-primary" v-on:click.prevent="editIngredient(ingredient, index)"><?php echo e(trans('sites.edit')); ?></button>
													<button class="btn-danger" v-on:click.prevent="deleteIngredient(ingredient, index)"><?php echo e(trans('sites.delete')); ?></button>
												</span>
								...
								<div class="col-md-12 text-center">
									<button class="col-md-2 col-md-offset-7 btn-warning" v-on:click.prevent="step1" ><?php echo e(trans('sites.back_step')); ?></button>
									<div class="col-md-1"></div>
									<button class="col-md-2 btn-success"  v-on:click.prevent="step3" ><?php echo e(trans('sites.next_step')); ?></button>
								</div>
							</div>
						</div>
						<!-- Second Step -->
						...
						<div id="checkout-third" class="step">
							...
							<ul class="nav nav-pills nav-justified checkout-steps push-bit">
								<li><a href="javascript:void(0)" data-gotostep="checkout-first" v-on:click.prevent="step1"><strong>1. <?php echo e(trans('sites.cooking_infomation')); ?></strong></a></li>
								<li><a href="javascript:void(0)" data-gotostep="checkout-second" v-on:click.prevent="step2"><strong>2. <?php echo e(trans('sites.cooking_ingredient')); ?></strong></a></li>
								<li class="active"><a href="javascript:void(0)" data-gotostep="checkout-third" v-on:click.prevent="step3"><strong>3. <?php echo e(trans('sites.cooking_step')); ?></strong></a></li>
								<li><a href="javascript:void(0)" data-gotostep="checkout-fourth" v-on:click.prevent="step4"><strong>4. <?php echo e(trans('sites.cooking_category')); ?></strong></a></li>
							</ul>
							<!-- END Step Info -->
							<div class="row">
								<div class="col-sm-5">
									<h4 class="page-header"><i class="fa fa-credit-card"></i><?php echo e(trans('sites.input_step')); ?></h4>
									<div class="form-group">
										...
										<button class="btn-warning" v-if="stepIndex != null" v-on:click.prevent="sendStep"><?php echo e(trans('sites.edit_step')); ?></button>
										<button class="btn-primary" v-if="stepIndex != null" v-on:click.prevent="cancelStep"><?php echo e(trans('sites.cancel')); ?></button>
										<button v-else="stepIndex != null" class="btn-success" v-on:click.prevent="sendStep"><?php echo e(trans('sites.add_step')); ?></button>
									</div>
								</div>
								<div class="col-sm-7">
									<h4 class="page-header"><?php echo e(trans('sites.cooking_step_list')); ?></h4>
									<div class="form-group">
										<ol>
											<div v-for="(step, index) in cooking.steps" >
												<button class="btn-warning" v-on:click.prevent="cancelStep" v-if="step.id == cookingStep.id"><?php echo e(trans('sites.editing')); ?></button>
												<span v-else="step.id == cookingStep.id">
													<button v-on:click.prevent="editStep(step, index)" class="btn-primary"><?php echo e(trans('sites.edit')); ?></button>
												<button v-on:click.prevent="deleteStep(step, index)" class="btn-danger"><?php echo e(trans('sites.delete')); ?></button>
												</span>
												<li class="col-md-12">
													<p>{{ step.content }}</p>
								...
								<div class="col-md-12 text-center">
									<button class="col-md-2 col-md-offset-7 btn-warning" v-on:click.prevent="step2" ><?php echo e(trans('sites.back_step')); ?></button>
									<div class="col-md-1"></div>
									<button class="col-md-2 btn-success"  v-on:click.prevent="step4" ><?php echo e(trans('sites.next_step')); ?></button>
								</div>
							</div>
						</div>
						<!-- END Third Step -->
						...
						<div id="checkout-fourth" class="step">
							...
							<ul class="nav nav-pills nav-justified checkout-steps push-bit">
								...
								<li><a href="javascript:void(0)" data-gotostep="checkout-second" v-on:click.prevent="step2"><strong>2. <?php echo e(trans('sites.cooking_ingredient')); ?></strong></a></li>
								<li><a href="javascript:void(0)" data-gotostep="checkout-third" v-on:click.prevent="step3"><strong>3. <?php echo e(trans('sites.cooking_step')); ?></strong></a></li>
								<li class="active"><a href="javascript:void(0)" data-gotostep="checkout-fourth" v-on:click.prevent="step4"><strong>4. <?php echo e(trans('sites.cooking_category')); ?></strong></a></li>
							</ul>
							<!-- END Step Info -->
							<div class="col-md-12">
							...
							<div class="col-md-12 text-center row">
									<button class="col-md-2 col-md-offset-10 btn-warning" v-on:click.prevent="step3" ><?php echo e(trans('sites.back_step')); ?></button>
							</div>
						</div>
						<!-- END Fourth Step -->
			            ...
			            <div class="modal-dialog">
			                <div class="modal-content">
			                    <div class="modal-header">
			                        ...
			                        <h4 class="modal-title custom_align" id="Heading"><?php echo e(trans('sites.create_cooking')); ?></h4>
			                    </div>
			                    ...
			                    <div class="modal-footer ">
			                        <a href="javascript:void(0)" v-on:click="submit" class="btn btn-success">
			                            <span class="glyphicon glyphicon-ok-sign"></span> <?php echo e(trans('sites.create')); ?>

			                        </a>
			                        <button type="button" class="btn btn-warning" data-dismiss="modal">
			                            <span class="glyphicon glyphicon-remove"></span> <?php echo e(trans('sites.cancel')); ?>
			            ...
			            <div class="modal-dialog">
			                <div class="modal-content">
			                    <div class="modal-header">
			                        ...
			                        <h4 class="modal-title custom_align" id="Heading"><?php echo e(trans('sites.reset_cooking')); ?></h4>
			                    </div>
...
<?php $__env->startSection('script'); ?>
	<?php echo e(Html::script('sites_custom/js/add.js')); ?>
