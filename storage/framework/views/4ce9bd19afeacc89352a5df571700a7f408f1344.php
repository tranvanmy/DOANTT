...
<html>
    <head>
        ...
        <?php echo e(Html::style('sites_custom/css/app.css')); ?>

        
        <?php echo e(Html::style('bower/font-awesome/css/font-awesome.min.css')); ?>

        
        <?php echo e(Html::style('sites_custom/css/custom.css')); ?>

        <?php echo e(Html::style('sites_custom/css/dashboard1.css')); ?>

        
        <?php echo e(Html::style('bower/themify-icons/css/themify-icons.css')); ?>

        <?php echo e(Html::style('bower/bootstrap-select/dist/css/bootstrap-select.min.css')); ?>

        <?php echo e(Html::style('bower/toastr/toastr.min.css')); ?>

        <?php echo e(Html::style('admin/css/customAdmin.css')); ?>
    ...
    <body class="skin-default">
        <div class="preloader">
            <div class="loader_img"><img src="<?php echo e(asset('images/admin/img/loader.gif')); ?>" alt="loading..."></div>
        </div>
        <header class="header">
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle padding-user" data-toggle="dropdown">
                                <img src="<?php echo e(Auth::user()->avatar); ?>" width="35" class="img-circle img-responsive pull-left" height="35" alt="User Image">
                                <div class="riot">
                                    <div>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="p-t-3" style="color: #1b1b1c;">
                                    <a v-on:click="showInfor(<?php echo e(Auth::user()->id); ?>)">
                                        <i class="fas fa-user-alt"></i>
                                        <?php echo e(trans('admin.my_profile')); ?>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">
                                        <i class="fa fa-paint-brush" aria-hidden="true"></i> <?php echo e(trans('admin.infor')); ?>
                                ...
                                <div class="modal-footer">
                                 <button type="button" class="btn btn-success" v-on:click="update_admin(fillItem.id)"><?php echo e(trans('admin.account_setting')); ?></button>
                                    ...
                                    <form method="POST" enctype="multipart/form-data" v-on:submit.prevent="updateAdmin(fillItem.id)">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group col-md-4" >
                                             ...
                                             <div class="form-group col-md-4" >
                                                <label for="name"><?php echo e(trans('admin.newpasss')); ?></label>
                                        ...
                                        <div class="clearfix"></div>
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-success"> <?php echo e(trans('admin.update_account')); ?>

                                                </button>
                                                <button type="button" class="btn btn-default" data-dismiss="modal">
                                                    <?php echo e(trans('sites.close')); ?>
                        ...
                        <div class="nav_profile">
                            <div class="media profile-left">
                                <a class="pull-left profile-thumb" href="#">
                                    <img src="<?php echo e(Auth::user()->avatar); ?>" class="img-circle" alt="User Image"></a>
                        ...
                        <ul class="navigation">
                            <li>
                                <a href="<?php echo e(route('admin.report')); ?>">
                                    ...
                                    <span class="mm-text "><?php echo e(trans('admin.dashboard')); ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('admin.cooking.index')); ?>">
                                    <i class="menu-icon ti-files"></i>
                                    <span><?php echo e(trans('admin.cooking')); ?></span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li class="menu-dropdown">
                                <a href="<?php echo e(route('admin.user.index')); ?>">
                                    ...
                                    <span><?php echo e(trans('admin.user')); ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('admin.ingredient.index')); ?>">
                                    <i class="menu-icon ti-server"></i>
                                    <span><?php echo e(trans('admin.ingredient')); ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('admin.order.index')); ?>">
                                    <i class="menu-icon ti-check-box"></i>
                                    <span><?php echo e(trans('admin.order')); ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('admin.post.index')); ?>">
                                    <i class="menu-icon ti-gallery"></i>
                                    <span><?php echo e(trans('admin.post')); ?></span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('admin.unit.index')); ?>" style="margin-left: 4px;">
                                        <i class="fas fa-university"></i>  
                                    <span style="margin-left: 8px;">Đơn Vị</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('admin.subcrice.index')); ?>" style="margin-left: 4px;">
                                        <i class="fas fa-heart"></i>
                                    <span style="margin-left: 8px;"><?php echo e(trans('admin.subscribe')); ?></span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="http://my.vchat.vn/home/type.php?module=msg" target="_blank">
                                  <i class="menu-icon ti-layout-placeholder"></i>
                                    <span><?php echo e(trans('admin.inbox')); ?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
        ...
        <?php echo e(Html::script('sites_custom/js/app.js')); ?>

        <?php echo e(Html::script('sites_custom/js/jquery.flot.spline.js')); ?>
        ...
        <?php echo e(Html::script('bower/bootstrap-select/dist/js/bootstrap-select.min.js')); ?>

        <?php echo e(Html::script('bower/toastr/toastr.min.js')); ?>

        <?php echo e(Html::script('admin/profile_admin.js')); ?>
