...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content p-l-r-15" id="manage-vue">
            <button  type="button" class="btn btn-success" data-toggle="modal" v-on:click="addItem" style="margin-top: 6px; margin-left: 10px;">
                <i class="ti-plus"></i> <?php echo e(trans('admin.create')); ?>
                                        ...
                                        <table class="table table-bordered dataTable no-footer" id="table" role="grid" aria-describedby="table_info">
                                            ...
                                            <tbody>
                                                <tr role="row" v-for="item in items">
                                                    ...
                                                    <td>{{ item.name }}</td>
                                                    <td v-if="item.type == 0">
                                                        <span class="label label-success"><?php echo e(trans('admin.ingredient_main')); ?></span>
                                                    </td>
                                                    <td v-if="item.type == 1">
                                                        <span class="label label-primary"><?php echo e(trans('admin.ingredient_sub')); ?></span>
                                                    </td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><?php echo e(trans('admin.ingredient_new')); ?></h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label><?php echo e(trans('admin.ingredient_name')); ?></label>
                            <input type="text" name="name" class="form-control" v-model="newItem.name" placeholder="<?php echo e(trans('admin.ingredient_name')); ?>" />
                            <span v-if="formErrors['name']" class="error text-danger">{{ formErrors['name'][0] }}</span>
                            <br>
                            <label for="type"><?php echo e(trans('admin.ingredient_type')); ?></label>
                            <select  class="input-sm" name="type" id="" v-model="newItem.type" >
                                <option v-bind:value="0"><?php echo e(trans('admin.ingredient_main')); ?></option>
                                <option v-bind:value="1"><?php echo e(trans('admin.ingredient_sub')); ?></option>
                            </select>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><?php echo e(trans('admin.ingredient_edit')); ?></h4>
                    </div>
                    <div class="modal-body">
                    <div class="form-group">
                        <label for="name"><?php echo e(trans('admin.ingredient_name')); ?></label>
...
<?php $__env->startSection('script'); ?>
    <?php echo e(Html::script('admin/ingredient.js')); ?>
